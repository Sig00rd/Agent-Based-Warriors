...
red_agents_squad = UserSettableParameter('slider', "Number of red agents squad", 3, 1, 5, 1)
...
blue_agents_squad = UserSettableParameter('slider', "Number of blue agents squad", 3, 1, 5, 1)
...
canvas = ContinuousWorld(agent_portrayal, 50, 50, 750, 750)
